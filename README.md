# Hisoka - 非認知能力の発見プラットフォーム

> **密かにやっていることが、その人の才能になる。**

## コンセプト

密か(Hisoka)は、**点数では測れない「非認知能力」を見つけて、伸ばす**ためのサービスです。

数学の点数のように数値化できる力ではなく、**仲間をつくる力・場を和ませる会話力・気を利かせる力・
自分の役割を掴む力**——こうした力は、いろんなチームで人と関わり学び合う中で、
誰の中にも“密かに”育っています。

例えば、幼い頃からチームスポーツをやってきた人は、たいてい気が利く。チームで機能するには、
まわりに気を配り、自分の役割を掴む必要があるからです。そうやって身についた力は、テストには
出ないけれど、その人らしさ・強みそのもの。

密かは、目標・活動・振り返りの記録から、その人が**密かに積み重ねてきた非認知能力を見つけ出し、
言語化し、伸ばす**手伝いをします。**見つけて伸ばすほど、その人の人生はもっと豊かになる**——
それが密かの目指すところです。

- 世界観・LPのアートディレクションは [docs/lp-art-direction.md](docs/lp-art-direction.md) を参照。
